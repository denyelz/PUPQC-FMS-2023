                    ...
                    <div class="modal fade" id="modal-xl-create">
                        <div class="modal-dialog modal-dialog-centered modal-l">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-between">
                                    <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Cancek</button>
                                    <button type="button" class="btn btn-outline-primary swalDefaultSuccess">Submit</button>
                                </div>
                            </div>
                        <!-- /.modal-content -->
                        </div>
