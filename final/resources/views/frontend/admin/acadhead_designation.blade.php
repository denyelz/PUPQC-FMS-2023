    ...
    {{-- LEFT NAVBAR --}}
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                    ...
                    <div class="mr-5 ml-5">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title mt-2">List of Designations</h3>
                                <div class="text-right">
                                    <button data-toggle="modal" data-target="#modal-xl-create" type="button" class="px-4 py-2 text-sm font-medium text-center text-white bg-green-800 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Create New Designation</button>
                                </div>
                            </div>
                ...
                <section class="content">
                <form action="{{route('CreateDesignation')}}" method="post">
                @csrf 
