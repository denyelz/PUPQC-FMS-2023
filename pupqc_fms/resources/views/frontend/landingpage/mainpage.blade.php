...
<head>
    ...
    <link rel="stylesheet" href="dist/css/farms.min.css">

    <!-- Pallete style -->
    <link rel="stylesheet" href="dist/css/farms.pallete.css">
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="dist/img/pup.png" height="60" width="60">
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="">
                                ...
                                <div class="row btn-group mt-lg-4">
                                    ...
                                    <div class="col-3">
                                        <a id="show-modal-loggedIn" class="btn btn-primary
                                                d-inline-block m-0">Login</a>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <!-- Main Script -->
    <script src="dist/js/farms.js"></script>
    ...
    <script src="dist/js/farms.swal.warning.modal.js"></script>

    <!-- Local script for success modals -->
    <script src="dist/js/farms.swal.success.modal.js"></script>

    <script>
        document.getElementById('show-modal-loggedIn').addEventListener('click', function() {
            Swal.fire({
                position: 'top-end',
                icon: 'success',
                ...
                timerProgressBar: true,
                    didOpen: () => {
                        setTimeout(() => {
                        window.location.replace('acadhead_setup/acad_head_dashboard.html');
                        }, 1500);
                    }
            });
        });
